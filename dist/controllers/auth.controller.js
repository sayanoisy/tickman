...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, name, email, password, data, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _auth["default"].signUp(name, email, password);
        case 4:
          data = _context.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          response = (0, _ResponseHandler["default"])(_httpStatusCodes.StatusCodes.OK, _Messages["default"].SUCCESS, "Logged out successfully");
