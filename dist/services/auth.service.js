...
var _JwtHandler = require("../utils/JwtHandler");
...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password) {
    var hashedPassword, signUpObject, generatedToken;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          signUpObject = new _User["default"]({
            name: name,
            email: email,
            password: hashedPassword
          });
          _context.next = 7;
          return _user["default"].saveUser(signUpObject);
        case 7:
          generatedToken = (0, _JwtHandler.generateToken)({
            name: name,
            email: email
          });
          return _context.abrupt("return", generatedToken);
        case 11:
          _context.prev = 11;
...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(email, password) {
    var user, matchCred, invalidCredsError, generatedToken;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 6:
          matchCred = _context2.sent;
          if (matchCred) {
            _context2.next = 10;
            break;
          }
          invalidCredsError = new _CustomError["default"](_Messages["default"].INVALID_LOGIN_CREDS, _httpStatusCodes.StatusCodes.UNAUTHORIZED);
